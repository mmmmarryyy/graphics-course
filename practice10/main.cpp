...
int main() try
{
    ...
    GLuint camera_position_env_location = glGetUniformLocation(environment_program, "camera_position");
    GLuint environment_map_texture_location = glGetUniformLocation(environment_program, "environment_map_texture");
    ...
    GLuint environment_map = load_texture(project_root + "/textures/environment_map.jpg");
    ...
    while (running)
    {
        ...
        glUniform3fv(camera_position_env_location, 1, reinterpret_cast<float *>(&camera_position));
